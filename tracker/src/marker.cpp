...
int main (int argc, char** argv)
{
	...
	while(ros::ok())
	{
	 ...
	 marker_array.markers[0].header.frame_id = "/camera_color_optical_frame";
	 ...
	 // Set the frame ID and timestamp.  See the TF tutorials for information on these.
	 marker_array.markers[1].header.frame_id = "/camera_color_optical_frame";
	 ...
	 // Set the frame ID and timestamp.  See the TF tutorials for information on these.
	 marker_array.markers[2].header.frame_id = "/camera_color_optical_frame";
