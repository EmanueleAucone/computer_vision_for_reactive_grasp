...
#ifndef GUARD_REACTIVE_GRASPING_DETECTION_STANDALONE_H
#define GUARD_REACTIVE_GRASPING_DETECTION_STANDALONE_H
...
#define DEFAULT_CONTACT_DETECTION_TOPIC_NAME "contact_detection"
#define DEFAULT_IMU_ID_TOPIC_NAME "imu_id"
...
class ReactiveGraspingDetection {
 ...
 private:
  ...
  ros::Publisher contact_detection_;
  ros::Publisher publish_primitive;
  ros::Publisher imu_id_publisher_;
  ...
  std::string contact_detection_topic_name_;
  std::string action_server_;
  std::string imu_id_topic_name_;
