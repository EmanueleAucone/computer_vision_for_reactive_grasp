...
const int thumb_imus[1] = {12};
const int index_imus[1] = {9};
const int middle_imus[1] = {6};
const int ring_imus[1] = {3};
const int little_imus[1] = {0};
...
void checkForCollision(){
	...
	if(DEBUG) std::cout << "THUMB OUTPUT IS " << thumb_output["output_signals"] << std::endl;
